...
export default function About() {
    const[mode,changeColor]=useState({color:"black",backgroundColor:"white"});
    const[buttonName,textChange]=useState("Enable Dark Mode");


    const changeMode=()=>{
        if(mode.color=="black")
        {
            changeColor({color:"white",backgroundColor:"black"});
            textChange("Disable Dark Mode");
        }
        else 
        {
            changeColor({color:"black",backgroungColor:"white"});
        ...
        <div className="container" style={mode}>
            ...
            <div className="accordion" id="accordionExample" style={mode}>
                <div className="accordion-item" style={mode}>
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample" style={mode}>
                ...
                <div className="accordion-item" style={mode}>
                    ...
                    <div id="collapseTwo" style={mode} className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
            ...
            <button onClick={changeMode}>{buttonName}</button>
        </div>
    )
}
